...
const Monsters = () => (
  ...
  <div className='app__monster section__padding gradient__bg'>
    <div className="app__monster-header">
      ...
      <p className='p__raleway'>The base game already includes a total amount of 334 monsters! However the Monster Manual includes a guide that lets you create your own monsters.</p>
    </div>
    <div className="app__monster-cards">
      <MonstersCall />
    </div>
